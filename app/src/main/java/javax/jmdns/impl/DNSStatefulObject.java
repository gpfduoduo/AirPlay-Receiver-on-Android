...
public interface DNSStatefulObject
{
     ...
     * <p>
     * Implementation note: this class is based on {@link Semaphore} so that
     * they can be released by the timeout timer.
     * </p>
     *
     * @author Pierre Frisch
     */
    ...
    {
        private static Logger logger = Logger.getLogger(DNSStatefulObjectSemaphore.class
                .getName());
            ...
            DNSStatefulObject
    {
        ...
        public String toString()
        {
            ...
            {
                return (_dns != null ? "DNS: " + _dns.getName() : "NO DNS") + " state: "
                    + _state + " task: " + _task;
            }
        }
