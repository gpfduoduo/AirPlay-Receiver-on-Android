...
public class ListenerStatus<T extends EventListener>
{
    ...
    {
        private static Logger logger = Logger.getLogger(ServiceListenerStatus.class
                .getName());
        ...
        void serviceAdded(ServiceEvent event)
        {
            ...
            if (null == _addedServices
                    .putIfAbsent(qualifiedName, event.getInfo().clone()))
            {
        ...
        synchronized void serviceResolved(ServiceEvent event)
        {
            ...
            if ((info != null) && (info.hasData()))
            {
                ...
                if (!_sameInfo(info, previousServiceInfo))
                {
                    ...
                    {
                        if (_addedServices.replace(qualifiedName, previousServiceInfo,
                            info.clone()))
                        {
                            this.getListener().serviceResolved(event);
                        }
    ...
    {
        private static Logger logger = Logger.getLogger(ServiceTypeListenerStatus.class
                .getName());
